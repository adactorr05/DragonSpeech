 ...
 * - left setupAnim empty). Used by ElderElfEntity.
 ...
 */
public class ElderElfEntityModel<T extends LivingEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(DragonSpeech.id("elder_elf"), "main");
	...
	public ElderElfEntityModel(ModelPart root) {
