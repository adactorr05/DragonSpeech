 ...
 * - left setupAnim empty). Used by HumanMageEntity.
 ...
 */
public class HumanMageEntityModel<T extends LivingEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(DragonSpeech.id("human_mage"), "main");
	...
	public HumanMageEntityModel(ModelPart root) {
