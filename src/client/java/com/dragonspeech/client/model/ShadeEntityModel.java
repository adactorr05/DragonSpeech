 ...
 * - left setupAnim empty). Used by ShadeEntity - renamed from the export's \"PowerfulShadeEntityModel\"/\"powerful_shade\" to match ShadeEntity's actual registered id (\"shade\").
 ...
 */
public class ShadeEntityModel<T extends LivingEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(DragonSpeech.id("shade"), "main");
